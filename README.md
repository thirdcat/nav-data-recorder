...
Two routes, both Mac-free: a **free** one that builds an unsigned .ipa on
GitHub Actions for a sideloader to re-sign with a free Apple ID, and a **paid**
one ($99/yr) that signs and ships to TestFlight. Setup for both is in
